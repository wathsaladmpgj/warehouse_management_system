...
@WebServlet(name = "OutletStaffServlet", urlPatterns = {"/OutletStaffServlet"})
public class OutletStaffServlet extends HttpServlet {
    ...
    private void insertStaff(HttpServletRequest request, HttpServletResponse response)
        ...
        if (success) {
            request.setAttribute("successMessage", "Staff member '" + name + "' has been successfully added to " + location);
        } else {
            request.setAttribute("errorMessage", "Failed to add staff member. Please try again.");
        }

        // Forward back to the form page instead of redirecting
        request.getRequestDispatcher("pages/StaffFormOutlet.jsp").forward(request, response);
    }
    ...
    private void updateStaff(HttpServletRequest request, HttpServletResponse response)
        ...
        if (success) {
            request.setAttribute("successMessage", "Staff member updated successfully.");
        } else {
            request.setAttribute("errorMessage", "Failed to update staff member. Please try again.");
        }
