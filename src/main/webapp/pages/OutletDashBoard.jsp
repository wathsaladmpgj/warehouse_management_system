    ...
    <body>
        <div class="dashboard-container">
            ...
            <aside class="sidebar">
                ...
                <nav>
                    ...
                    <!-- In the sidebar navigation section of OutletDashBoard.jsp -->
                    <div class="sidebar-item">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (newItemsCount > 0)
                    animateValue('newItemsCount', 0, newItemsCount, 1000);
                if (registeredItemsCount > 0)
                    animateValue('registeredItemsCount', 0, registeredItemsCount, 1000);
                if (availableItemsCount > 0)
                    animateValue('availableItemsCount', 0, availableItemsCount, 1000);
                if (successItemsCount > 0)
                    animateValue('successItemsCount', 0, successItemsCount, 1000);
